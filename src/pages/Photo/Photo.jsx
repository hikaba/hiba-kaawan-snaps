        ...
        <div>
            <ul className="photo-list">
                <li className="photo-list__item">
                    <img src={photo.photo} alt={photo.photoDescription} className="photo-list__image"/>
                    <div className="photo-list__container">
                        <ul className="photo-list__tags">
                            {photo.tags.map((tag, index) => (
                                <li key={index} className="photo-list__tag-item">{tag}</li>
                            ))}
                        </ul>    
                        <div className="photo-list__container-details">
                            ...
                            <p className="photo-list__details">{photo.likes} likes</p>                               
                            <p className="photo-list__details photo-list__date">{fullDate}</p> 
                        </div>               
                        <p className="photo-list__details">Photo by {photo.photographer}</p>
                    </div>
                </li>
            </ul>
        </div>
